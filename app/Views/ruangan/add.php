                ...
                <div class="card-body">
                    <form action="/ruangan" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control <?= ($validation->hasError('kode')) ? 'is-invalid' : ''; ?>" name="kode" id="kode" value="<?= old('kode'); ?>" placeholder="Ex: RG001">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" name="nama" id="nama" value="<?= old('nama'); ?>" placeholder="Nama Ruangan...">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-sm-9">
                                <select name="gedung" id="gedung" class="form-control <?= ($validation->hasError('gedung')) ? 'is-invalid' : ''; ?>">
                                    ...
                                    <?php foreach ($gedung as $g) : ?>
                                        <option value="<?= $g['id_gedung']; ?>" <?= (old('gedung') == $g['nama_gedung']) ? 'selected' : ''; ?>><?= $g['nama_gedung']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <div class="invalid-feedback">
