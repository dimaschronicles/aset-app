                ...
                <div class="card-body">
                    <form action="/aset" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="kode_aset" class="form-control <?= ($validation->hasError('kode_aset')) ? 'is-invalid' : ''; ?>" id="kode_aset" name="kode_aset" value="<?= $kode_aset; ?>" readonly>
                            ...
                            <div class="col-sm-9">
                                <select class="form-control <?= ($validation->hasError('nama_aset')) ? 'is-invalid' : ''; ?>" name="nama_aset" id="nama_aset">
                                    ...
                                    <?php foreach ($barang as $b) : ?>
                                        <option value="<?= $b['id_barang']; ?>" <?= (old('nama_aset') == $b['id_barang']) ? 'selected' : ''; ?>><?= $b['nama_barang']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control <?= ($validation->hasError('jumlah')) ? 'is-invalid' : ''; ?>" id="jumlah" name="jumlah" value="<?= old('jumlah'); ?>" placeholder="Masukan jumlah...">
                                <div class="invalid-feedback">
                                    ...
                                    <div class="col">
                                        <select class="form-control <?= ($validation->hasError('gedung')) ? 'is-invalid' : ''; ?>" name="gedung" id="gedung">
                                            ...
                                            <?php foreach ($gedung as $g) : ?>
                                                <option value="<?= $g['id_gedung']; ?>" <?= ($gedung_selected == $g['id_gedung'] || old('gedung') == $g['id_gedung']) ? 'selected' : ''; ?>><?= $g['nama_gedung']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col">
                                        <select class="form-control <?= ($validation->hasError('ruangan')) ? 'is-invalid' : ''; ?>" name="ruangan" id="ruangan">
                                            ...
                                            <?php foreach ($ruangan as $r) : ?>
                                                <option value="<?= $r['id_ruangan']; ?>" <?= ($ruangan_selected == $r['id_gedung'] || old('ruangan') == $r['id_ruangan']) ? 'selected' : ''; ?> class="<?= $r['id_gedung']; ?>"><?= $r['nama_ruangan']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <div class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control  <?= ($validation->hasError('nilai_aset')) ? 'is-invalid' : ''; ?>" name="nilai_aset" id="nilai_aset" value="<?= old('nilai_aset'); ?>" name="nilai_aset" id="nilai_aset" aria-label="Nominal" aria-describedby="basic-addon1" placeholder="000">
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control <?= ($validation->hasError('sumber')) ? 'is-invalid' : ''; ?>" name="sumber" id="sumber">
                                    ...
                                    <?php foreach ($supplier as $s) : ?>
                                        <option value="<?= $s['id_supplier']; ?>" <?= (old('sumber') == $s['nama']) ? 'selected' : ''; ?>><?= $s['nama']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea type="text" class="form-control <?= ($validation->hasError('keterangan')) ? 'is-invalid' : ''; ?>" name="keterangan" id="keterangan" rows="3"><?= old('keterangan'); ?></textarea>
                                <div class="invalid-feedback">
